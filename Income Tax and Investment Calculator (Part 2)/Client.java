...
*Student No: C3394937
*Date: 26/05/2022
*Description: This file contains an array of Account class and all the methods for inputting several variables like name,salary,weekly expenses and calculating tax and medicare.
*/
...
public class Client
{
    ...
    public Client(){
        savingAccount = new Account[2];
        for(int i = 0; i < savingAccount.length; i++) 
        savingAccount[i] = new Account();
    }
    ...
    public void setResidenceStatus(boolean r){              // method definition of setting the residence //
        if(r){
            resident = true;
        }
        else if(r = false){
    ...
    public boolean getResidenceStatus()                     // method definition of returning the value of resident //
    {
        return(resident);
    }
}
