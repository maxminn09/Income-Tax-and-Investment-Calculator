 ...
 *Student No: C3394937
 *Date: 26/05/2022
 *Description: This file contains the constructors of Account class and  all the methods for setting the rate of investment, the amount for investment, the number of weeks for
 *             investment and calculating the invested amount
...
public class Account
{
    ...
    public Account(double newRate, int noWeeks, double newAmount)
    {
        rate = newRate;
        numberOfWeeks = noWeeks;
        amount = newAmount;
    }
